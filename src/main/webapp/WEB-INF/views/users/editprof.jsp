    ...
    <jsp:body>
        ...
        <div class="row">
            ...
            <div class="span-two-thirds">
              <form:form modelAttribute="user" action="e" method="post" enctype="multipart/form-data">
                ...
                <fieldset>
                  ...
                  <div class="clearfix">
                    ...
                    <div class="input">
                      <form:input path="prename" cssClass="xlarge" cssErrorClass="xlarge error" value="${profile.prename}"/>
                  ...
                  <div class="clearfix">
                    ...
                    <div class="input">
                      <form:input path="surname" cssClass="xlarge" cssErrorClass="xlarge error" value="${profile.surname}" />
                  ...
                  <div class="clearfix">
                    ...
                    <div class="input">
                      <form:input path="birthdate" cssClass="xlarge" cssErrorClass="xlarge error" value="${birthday}" />
                  ...
                  <div class="clearfix">
                    ...
                    <div class="input">
                      <form:input path="city" cssClass="xlarge" cssErrorClass="xlarge error" value="${profile.city}"/>
                  ...
                  <div class="clearfix">
                    ...
                    <div class="input">
                      <form:input path="email" cssClass="xlarge" cssErrorClass="xlarge error" value="${profile.email}" />
                  ...
                  <div class="clearfix">
                    ...
                    <div class="input">
                      <form:password path="password" cssClass="xlarge" cssErrorClass="xlarge error" value="changeit" />
                  ...
                  <div class="clearfix">
                    ...
                    <div class="input">
                      <form:password path="repeat" cssClass="xlarge" cssErrorClass="xlarge error" value="changeit" />
                      <span class="help-block error"><form:errors path="repeat" /></span>
                    </div>
                  </div>
                  <div class="actions">
                    <input type="submit" class="btn primary"
                                value="Update">&nbsp;<a href="/users/${profile.id}" class="btn">Cancel</a>
                  </div>
                </fieldset>
              </form:form>
            </div>
