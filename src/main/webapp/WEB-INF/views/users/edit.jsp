    ...
    <jsp:body>
        ...
        <div class="row">
            ...
            <div class="span-two-thirds">
              <form:form modelAttribute="profile" action="/v1/users/${profile.id}/edit" method="post" enctype="multipart/form-data">
                ...
                <fieldset>
                  ...
                  <div class="actions">
                    <input type="submit" class="btn primary"
                                value="Update">&nbsp;<a href="/v1/users/${profile.id}" class="btn">Cancel</a>
                  </div>
                </fieldset>
              </form:form>
            </div>
